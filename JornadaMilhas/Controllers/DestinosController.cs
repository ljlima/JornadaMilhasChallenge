...
public class DestinosController : ControllerBase
{
        ...
        IMapper _mapper)
    {
        Configuration = new ConfigurationBuilder()
            .AddUserSecrets<DestinosController>()
            .Build();
    ...
    [HttpPut("{id}")]
    public IActionResult AtualizaDestino([FromRoute] int id,[FromBody] UpdateDestinosDto destinoDto)
    {
    ...
    {
        string OPENAI_API_KEY = Configuration["apiKeys: OPENAI_API_KEY"];
